...
const ERROR_TRANSLATIONS: Array<[RegExp, string]> = [
  ...
  [/TENANT_NOT_FOUND/i, 'Không tìm thấy đơn vị được chọn. Vui lòng tải lại danh sách.'],
  [/SELF_SERVICE_WORKSPACE_MANAGED_BY_SYSTEM/i, 'Giải của khách hàng tự đăng ký phải được khởi tạo bằng luồng mở khóa của hệ thống.'],
  [/SELF_SERVICE_OWNER_NOT_READY/i, 'Khách hàng chưa hoàn tất mở khóa nên chưa thể khởi tạo giải.'],
